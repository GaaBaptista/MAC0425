...
class ExactInference(InferenceModule):
    ...
    def observe(self, observation, gameState):
        ...
        # calcularemos a distancia com o método de distancia de manhattan disponivel no arquivo util.py
        # atualizaremos as probabilidades de acordo com a crença do agente
        for p in self.legalPositions:
            trueDistance = util.manhattanDistance(p, pacmanPosition)
            allPossible[p] = self.beliefs[p] * emissionModel[trueDistance]

        # aqui faremos a verificação como sugerida na descrição do observe
